...
##### Create tomcat & amdp account
useradd -c "Account for Tomcat" tomcat
echo 'tomcat:Ezwel123!' | sudo chpasswd
useradd -c "Account for amdp" amdp
echo 'amdp:Ezwel123!' | sudo chpasswd
...
chown -R tomcat:tomcat /data                                # Change ownership of /data to tomcat user
